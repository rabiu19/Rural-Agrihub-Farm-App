...
class InventoryController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				inventory.reorder_level LIKE ? OR 
				inventory.selling_price LIKE ? OR 
				inventory.status LIKE ? OR 
				inventory.cost_price LIKE ? OR 
				inventory.image LIKE ? OR 
				inventory.date_created LIKE ? OR 
				inventory.date_updated LIKE ?
			)";
			$search_params = array(
		...
		$view_name = (is_ajax() ? "inventory/ajax-list.php" : "inventory/list.php");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","description","qty_in_stock","reorder_level","selling_price","status","cost_price","image");
			...
			$this->sanitize_array = array(
				...
				'reorder_level' => 'sanitize_string',
				'selling_price' => 'sanitize_string',
				'status' => 'sanitize_string',
				'cost_price' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","description","qty_in_stock","reorder_level","selling_price","status","cost_price","image");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
