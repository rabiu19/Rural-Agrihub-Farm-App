                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-town"  value="<?php  echo $data['town']; ?>" type="text" placeholder="Enter Town or City"  required="" name="town"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
