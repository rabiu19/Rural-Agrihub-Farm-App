                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-commodity_produce"> Commodity Produce</th>
                                                <th  class="td-farm_size"> Farm Size</th>
                                                <th  class="td-farm_location"> Farm Location</th>
                                                <th  class="td-farm_location_address"> Farm Location Address</th>
                                                <th  class="td-farming_season_use"> Farming Season Use</th>
                                                <th  class="td-season_starts"> Season Starts</th>
                                                <th  class="td-season_ends"> Season Ends</th>
                                                <th  class="td-average_yearly_income_range"> Average Yearly Income Range</th>
                                                <th  class="td-other_source_of_income"> Other Source Of Income</th>
                                                <th  class="td-form_of_support_need"> Form Of Support Need</th>
