                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-qty_in_stock"  value="<?php  echo $this->set_field_value('qty_in_stock',""); ?>" type="text" placeholder="Enter Qty In Stock"  required="" name="qty_in_stock"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-reorder_level"  value="<?php  echo $this->set_field_value('reorder_level',""); ?>" type="text" placeholder="Enter Reorder Level"  required="" name="reorder_level"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-cost_price"  value="<?php  echo $this->set_field_value('cost_price',""); ?>" type="text" placeholder="Enter Cost Price"  required="" name="cost_price"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
