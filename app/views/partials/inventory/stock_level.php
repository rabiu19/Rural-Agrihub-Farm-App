                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="inventory-stock_level-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-reorder_level"> Reorder Level</th>
                                                <th  class="td-fullstock_level"> Fullstock Level</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id"><a href="<?php print_link("inventory/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                <td class="td-name">
                                                ...
                                                <td class="td-reorder_level">
                                                    <span  data-value="<?php echo $data['reorder_level']; ?>" 
                                                        data-pk="<?php echo $data['id'] ?>" 
                                                        data-url="<?php print_link("inventory/editfield/" . urlencode($data['id'])); ?>" 
                                                        data-name="reorder_level" 
                                                        data-title="Enter Reorder Level" 
                                                        data-placement="left" 
                                                        data-toggle="click" 
                                                        data-type="number" 
                                                        data-mode="popover" 
                                                ...
                                                <td class="td-fullstock_level">
                                                    <span  data-value="<?php echo $data['fullstock_level']; ?>" 
                                                        data-pk="<?php echo $data['id'] ?>" 
                                                        data-url="<?php print_link("inventory/editfield/" . urlencode($data['id'])); ?>" 
                                                        data-name="fullstock_level" 
                                                        data-title="Enter Fullstock Level" 
                                                        data-placement="left" 
                                                        data-toggle="click" 
                                                        data-type="number" 
                                                        data-mode="popover" 
