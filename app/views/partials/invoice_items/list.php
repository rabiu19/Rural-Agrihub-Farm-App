    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("invoice_items/add") ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-item_invt_id"> Item Invt Id</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("invoice_items/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-item_invt_id">
                                                        <span  data-value="<?php echo $data['item_invt_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("invoice_items/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="item_invt_id" 
                                                            data-title="Enter Item Invt Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
