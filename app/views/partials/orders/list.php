                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-commodity_need"> Commodity Need</th>
                                                <th  class="td-quantity"> Quantity</th>
                                                <th  class="td-expected_delivery_date"> Expected Delivery Date</th>
                                                <th  class="td-delivery_date"> Delivery Date</th>
                                                <th  class="td-delivery_status"> Delivery Status</th>
                                                <th  class="td-unit_price"> Unit Price</th>
                                                <th  class="td-amount"> Amount</th>
                                                <th  class="td-payment_status"> Payment Status</th>
                                                <th  class="td-delivered_by"> Delivered By</th>
